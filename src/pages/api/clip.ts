...
function downloadVideo(videoId: string, outputPath: string): Promise<void> {
...
function cutVideo(inputPath: string, outputPath: string, startTime: number, endTime: number): Promise<void> {
  return new Promise((resolve, reject) => {
